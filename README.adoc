...
image:https://img.shields.io/travis/oasp/oasp4js-ng-boot-project-seed/master.svg[Build Status (Travis CI), link=https://travis-ci.org/oasp/oasp4js-ng-boot-project-seed/master]
